"""Build and manage compact UDON3 cache products."""
...
def add_selection_arguments(parser: argparse.ArgumentParser) -> None:
    parser.add_argument("--mission", choices=backend.UDON3_MISSIONS)
    parser.add_argument(
        "--search",
        default="",
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Manage the 5 GB compact UDON3 preview and image cache"
    )
