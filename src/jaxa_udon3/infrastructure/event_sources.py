...
def udon3_file_url(
    ...
    return f"{UDON3_BASE_URL}/{mission}/{observation_id}/{filename}"
...
def remote_event_record(
    ...
    return EventFile(
        ...
        parquet_url=udon3_file_url(mission, observation_id, f"{stem}_events.parquet"),
        header_url=udon3_file_url(mission, observation_id, f"{stem}_hdr.json"),
        source="remote",
    )
