...
from jaxa_torax.desktop.background_work import BackgroundWorkMixin
from jaxa_torax.desktop.data_controller import search_catalog
from jaxa_torax.desktop.inspector import InspectorPanel
from jaxa_torax.desktop.main_refresh import RefreshMixin
from jaxa_torax.desktop.observation_loading import ObservationLoadingMixin
from jaxa_torax.desktop.panels import DataLayersPanel, ObservationBrowserDialog, SearchDialog
from jaxa_torax.desktop.science_views import combine_frames
from jaxa_torax.desktop.state import DesktopState
from jaxa_torax.desktop.theme import APP_QSS, JAXA_BLUE_BRIGHT
from jaxa_torax.desktop.viewer_3d_helpers import apply_camera_preset
from jaxa_torax.desktop.viewers import WorkspaceWidget
...
class MainWindow(BackgroundWorkMixin, ObservationLoadingMixin, WorkspacePersistenceMixin, RefreshMixin, WindowActionsMixin, QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("TORAX — DARTS X-ray Event Explorer")
