...
from jaxa_torax.domain import (  # noqa: F401
    EventFile,
    LoadedObservation,
    RGBBandConfig,
    SearchResult,
...
APP_DATA_ROOT = Path(
    os.environ.get("TORAX_DATA_ROOT", Path.cwd() / "var")
).expanduser().resolve()
...
TORAX_BASE_URL = "https://data.darts.isas.jaxa.jp/pub/app-data/udon3"
TORAX_MISSIONS = ("asca", "suzaku", "hitomi", "xrism")
KNOWN_INSTRUMENTS = {
    "asca": ("gis", "sis"),
    "suzaku": ("xis",),
    "hitomi": ("sxs", "sxi", "hxi"),
...
USER_AGENT = "Mozilla/5.0 DARTS-TORAX-PyVista/1.0"
...
PI_TO_KEV_FACTORS = {
    # Standard ASCA GIS PI has 1024 channels. Some TORAX files are 256-channel
